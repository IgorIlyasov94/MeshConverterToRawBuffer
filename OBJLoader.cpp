...
void OBJLoader::Load(const std::filesystem::path& filePath, bool calculateNormals, bool calculateTangents, bool smoothNormals,
...
std::string OBJLoader::GetToken(const std::string& objLine)
{
...
float2 OBJLoader::GetVector2(const std::string& objLine)
{
	std::stringstream objLineStream(objLine);
...
float3 OBJLoader::GetVector3(const std::string& objLine)
{
	std::stringstream objLineStream(objLine);
...
VertexFormat OBJLoader::GetFaceFormat(size_t texCoordCount, size_t normalCount)
{
...
void OBJLoader::GetFace(const std::string& objLine, VertexFormat faceFormat, std::vector<uint32_t>& face)
{
	std::stringstream objLineStream(objLine);
...
void OBJLoader::TriangulateFace(VertexFormat vertexFormat, const std::vector<float3>& positions, std::vector<uint32_t>& face)
{
...
float3 OBJLoader::CalculatePolygonCenter(VertexFormat vertexFormat, const std::vector<float3>& positions, const std::vector<uint32_t>& face)
{
	uint32_t faceStride = (vertexFormat == VertexFormat::POSITION) ? 1 : (vertexFormat == VertexFormat::POSITION_NORMAL_TEXCOORD) ? 3 : 2;
	uint32_t verticesCount = face.size() / faceStride;
...
float3 OBJLoader::CalculatePolygonNormal(VertexFormat vertexFormat, const std::vector<float3>& positions, const std::vector<uint32_t>& face)
{
	uint32_t faceStride = (vertexFormat == VertexFormat::POSITION) ? 1 : (vertexFormat == VertexFormat::POSITION_NORMAL_TEXCOORD) ? 3 : 2;
	uint32_t verticesCount = face.size() / faceStride;
...
float OBJLoader::CalculateTriangleArea(float3 position0, float3 position1, float3 position2)
{
...
float3 OBJLoader::CalculateBarycentric(float3 position0, float3 position1, float3 position2, float3 point)
{
...
bool OBJLoader::CheckPointInTriangle(float3 position0, float3 position1, float3 position2, float3 point)
{
...
bool OBJLoader::CheckTriangleInPolygon(float3 position0, float3 position1, float3 position2, float3 polygonNormal)
{
...
void OBJLoader::CalculateTangents(float3 normal, float3& tangent, float3& binormal)
{
...
void OBJLoader::CalculateTangents(const std::vector<float3>& normals, std::vector<float3>& tangents, std::vector<float3>& binormals)
{
...
void OBJLoader::CalculateNormals(VertexFormat vertexFormat, const std::vector<float3>& positions, std::vector<uint32_t>& faces, std::vector<float3>& normals)
{
...
void OBJLoader::SmoothNormals(VertexFormat vertexFormat, const std::vector<float3>& positions, const std::vector<uint32_t>& faces,
	std::vector<float3>& normals)
{
...
void OBJLoader::ComposeVertices(VertexFormat vertexFormat, const std::vector<float3>& positions, const std::vector<float3>& normals,
...
const std::vector<uint32_t> OBJLoader::GetFaceIndicesForSamePosition(VertexFormat vertexFormat, const std::vector<float3>& positions,
...
int64_t OBJLoader::GetIndexForSameVertex(uint32_t vertex4ByteStride, const std::vector<float>& vertices, const std::vector<uint32_t>& indices,
...
uint32_t OBJLoader::GetVertex4ByteStride(VertexFormat vertexFormat)
{
